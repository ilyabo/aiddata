...
cubism_contextPrototype.axis = function() {
  ...
  var format = context.step() < 6e4 ? cubism_axisFormatSeconds
      ...
      : context.step() < 864e5*30 ? cubism_axisFormatDays
      : context.step() < 864e5*30*2 ? cubism_axisFormatMonths
      : cubism_axisFormatYears;
...
var cubism_axisFormatSeconds = d3.time.format("%I:%M:%S %p"),
    ...
    cubism_axisFormatMonths = d3.time.format("%B %Y"),
    cubism_axisFormatYears = d3.time.format("%Y")
    ;
